...
int lv2::Run(sf::RenderWindow &Tela){
    ...
    maquina.setFont(font);
    maquina.setFillColor(sf::Color::Black);
    maquina.setString("Preste atencao!");
    maquina.setPosition(sf::Vector2f(100, 100));
    maquina.setCharacterSize(40);

    jogador.setFont(font);
    jogador.setFillColor(sf::Color::Black);
    jogador.setString("Agora repita :D");
    jogador.setPosition(sf::Vector2f(100, 100));
    jogador.setCharacterSize(40);
    ...
    filam.Insere(7);filam.Insere(5);filam.Insere(5);
    ...
    filam.Insere(5);filam.Insere(5);filam.Insere(7);
    filam.Insere(3);filam.Insere(5);filam.Insere(7);
    filam.Insere(8);filam.Insere(7);filam.Insere(3);
    filam.Insere(5);filam.Insere(7);filam.Insere(8);
    filam.Insere(7);filam.Insere(3);filam.Insere(7);
    filam.Insere(10);filam.Insere(10);
